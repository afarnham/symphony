defmodule SymphonyElixir.Tracker.Issue do
  ...
  defstruct [
    ...
    :assignee_id,
    assignee_ids: [],
    requested_backend: nil,
    ready_actor_id: nil,
    ready_actor_automated: nil,
    release_authorization: nil,
    blocked_by: [],
    labels: [],
    dispatchable: false,
    created_at: nil,
  ...
  @type t :: %__MODULE__{
          ...
          assignee_ids: [String.t()],
          requested_backend: String.t() | nil,
          ready_actor_id: String.t() | nil,
          ready_actor_automated: boolean() | nil,
          release_authorization: map() | nil,
          labels: [String.t()],
          blocked_by: [map()],
