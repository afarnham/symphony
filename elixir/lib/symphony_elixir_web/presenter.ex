defmodule SymphonyElixirWeb.Presenter do
  ...
  defp running_entry_payload(entry) do
    %{
      ...
      ready_actor: Map.get(entry, :ready_actor),
      eligible_worker_hosts: Map.get(entry, :eligible_worker_hosts),
  ...
  defp running_issue_payload(running) do
    %{
      ...
      ready_actor: Map.get(running, :ready_actor),
      eligible_worker_hosts: Map.get(running, :eligible_worker_hosts),
  ...
  defp retry_issue_payload(retry) do
    %{
      ...
      ready_actor: Map.get(retry, :ready_actor),
      eligible_worker_hosts: Map.get(retry, :eligible_worker_hosts),
  ...
  defp blocked_issue_payload(blocked) do
    %{
      ...
      profile: Map.get(blocked, :profile),
      ready_actor: Map.get(blocked, :ready_actor),
      eligible_worker_hosts: Map.get(blocked, :eligible_worker_hosts),
