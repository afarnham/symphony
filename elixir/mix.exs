    ...
    [
      ...
      test_coverage: [
        ...
        ignore_modules: [
          ...
          SymphonyElixir.AgentBackend.Claude,
          SymphonyElixir.Claude.Session,
          SymphonyElixir.GitHubProject.Client,
          SymphonyElixir.GitHubProject.Normalizer,
          SymphonyElixir.HttpServer,
          SymphonyElixir.SSH,
          SymphonyElixir.SSH.TunnelServer,
          SymphonyElixir.StatusDashboard,
          SymphonyElixir.TrackerMCP,
